...
import chooseusImg from "./assets/chooseusAsset.webp";
...
const BTemplate8 = () => {
	...
	const [landingImage, setLandingImage] = useState(heroImage);
	const [isSubscribed, setIsSubscribed] = useState(false);
	const [aboutusText, setAboutusText] = useState(
		"We are a leading shoes and accessories manufacturer, committed to providing high-quality products at competitive prices. Our skilled craftsmen and designers work tirelessly to create unique and trendy designs that meet the needs of our customers. Customer satisfaction is our top priority, and we strive to exceed their expectations with every order."
	);
